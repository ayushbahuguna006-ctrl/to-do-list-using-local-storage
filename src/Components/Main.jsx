...
function Main() {
  ...
  return (
    <div className='flex items-center justify-center'>
      ...
      {/*add button*/}
      <div className='p-10 flex md:justify-evenly justify-between '><input type="text" placeholder='TASK' value={task} onChange={(e)=>settask(e.target.value)} className='outline-none hover:border-blue-200 border border-black w-45 md:w-1/2 p-1 pl-4 rounded-lg font-semibold' /><button className='border-2 bg-blue-400
